...
export default function Admin() {
    ...
    useEffect(() => {
        async function getProjet() {
          try {
            const response = await fetch('https://back-w3learn.vercel.app/api/admin/getProjetNoValidate');
            if (response.ok) {
      ...
      function handleValidation(idProjet, isChecked) {
        ...
        fetch(`https://back-w3learn.vercel.app/api/admin/project/${idProjet}`, {
      ...
      function handleDelete(idProjet) {
        ...
        fetch(`https://back-w3learn.vercel.app/api/admin/deleteProject/${idProjet}`, {
      ...
      async function handleDescriptionUpdate(idProjet) {
        ...
        try {
          ...
          const response = await fetch(`https://back-w3learn.vercel.app/api/admin/updateProjectDescription/${idProjet}`, {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json',
            },
