  ...
  const {user, setUser} = useContext(AuthContext)
    ...
    const modifyUsername = async (newUsername) => {
      ...
      console.log("TEST STOP PROPAGATION");
        ...
        const response = await fetch("https://back-w3learn.vercel.app/api/gestionProfile/updateUsername", {
          method: "PATCH",
    ...
    async function modifyEmail(newEmail) {
      try {
        const response = await fetch("https://back-w3learn.vercel.app/api/gestionProfile/updateEmail", {
          method: "PATCH",
    ...
    async function deleteUserAccount() {
      try {
        const response = await fetch("https://back-w3learn.vercel.app/api/gestionProfile/deleteUserAccount", {
          method: "DELETE",
